 ...
 * @param {!Object} options
 */
const ytdl = (module.exports = { stream : _stream, urlGet: _urlGet })

const _urlGet = (videoUrl, args, options) => {
 ...
 const _stream = function (videoUrl, args, options) {
  ...
  ytdl.getInfo(videoUrl, args, options, function getInfo (err, data) {
    console.log("YOUTUBE INFO BEFORE STREAM")
